...
describe('Arg', function () {
    ...
    describe('hasState - field name and value matching', function(){
        ...
        it('Should pass valid assertions', function(){
            ...
            expect(arg.hasState({ number: 1, string: 'string', date: now })({ number: 1, string: 'string', date: now })).toBeTruthy();
            expect(arg.hasState({ number: 1, string: 'string', array: ['one', 'two', 'three'] })({ number: 1, string: 'string', array: ['one', 'two', 'three'] })).toBeTruthy();
